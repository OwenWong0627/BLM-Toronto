      ...
      <>
         ...
         <div data-testid="sidebar" className={sidebar ? 'side-menu active' : 'side-menu'}>
            <ul data-testid="checkbox-filter" className='side-menu-items'>
               ...
               <li><label><input type='checkbox' checked={selectAll} onChange={handleAllChecked} /><h2 className="checkAll">Check/Uncheck All</h2></label></li>
               {checkboxes.map(item => (
                  <Checkbox
                     key={item.name}
                     name={item.name}
         ...
         <div data-testid="map" className="Map">
            ...
            <Link data-testid="home-button" to="/">
               <img className='home' src='/BLM-Toronto-Logo.svg' alt='Home-Button' title='Go To Home Page'></img>
            </Link>
