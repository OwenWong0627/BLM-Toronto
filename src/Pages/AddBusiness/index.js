            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="form-control">
                    ...
                    >
                        ...
                        <option value="Art, Artists & Art Galleries">
                            Art, Artists & Art Galleries
                        </option>
                        <option value="Education, Books & Black Authors">
                            Education, Books & Black Authors
                        </option>
                        <option value="Business, Services & Technology">
                            Business, Services & Technology
                        </option>
                        <option value="Doctors, Health & Fitness">
                            Doctors, Health & Fitness
                        </option>
                        <option value="Real Estate & Home Services">
                            Real Estate & Home Services
                        </option>
                        <option value="Community & Faith Centers">
                            Community & Faith Centers
                        </option>
                        <option value="Hair, Barbers & Beauty">
                            Hair, Barbers & Beauty
                        </option>
                        <option value="Media, Events & Entertainment">
                            Media, Events & Entertainment
                        </option>
                        <option value="Restaurants, Bakeries & Grocery">
                            Restaurants, Bakeries & Grocery
                        </option>
                        <option value="Travel, Auto & Other Services">
                            Travel, Auto & Other Services
                        </option>
                    </select>
                    {errors.TYPE && (
                ...
                {isVirtual ? (
                    <div>
                        ...
                        <div className="form-control">
                            <label>
                                What is the postal code of the business?
                            </label>
                            <input
                ...
                <div className="form-control">
                    ...
                    {errors.WEBSITE && errors.WEBSITE.type === "pattern" && (
                        <p className="error-message">This is not a website</p>
                    )}
                </div>
                <div className="form-control">
